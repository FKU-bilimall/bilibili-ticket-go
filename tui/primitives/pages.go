...
type page struct {
	...
	Item    tview.Primitive // The page's primitive.
...
func (p *Pages) GetCurrentPage() tview.Primitive {
...
// the pages are drawn.
func (p *Pages) AddPage(name string, item tview.Primitive, resize, visible bool) *Pages {
	hasFocus := p.HasFocus()
...
// page.
func (p *Pages) AddAndSwitchToPage(name string, item tview.Primitive, resize bool) *Pages {
...
func (p *Pages) Focus(delegate func(p tview.Primitive)) {
	if delegate == nil {
...
func (p *Pages) MouseHandler() func(action tview.MouseAction, event *tcell.EventMouse, setFocus func(p tview.Primitive)) (consumed bool, capture tview.Primitive) {
...
func (p *Pages) InputHandler() func(event *tcell.EventKey, setFocus func(p tview.Primitive)) {
...
func (p *Pages) PasteHandler() func(pastedText string, setFocus func(p tview.Primitive)) {
